<div class="card mb-sm-12 mb-md-0 contacts_card" >
      ...
      <div class="card-body ">
              ...
              <form method="post" action="<?php echo e(route('add-from-vue')); ?>" id="formAddRoom">
                    ...
                    <div class="form-group">
                          ...
                          <div class="col-md-12">
                              <input id="room_label" type="text" class="my-input-texte form-control<?php echo e($errors->has('room_label') ? ' is-invalid' : ''); ?> " name="room_label" value="<?php echo e(old('room_label') ? old('room_label') : ''); ?>" required autofocus>

                            <?php if($errors->has('room_label')): ?>
                                <span class="invalid-feedback" role="alert">
                                    <strong><?php echo e($errors->first('room_label')); ?></strong>
                                </span>
                            <?php endif; ?>
                        </div>                    
                    </div>
                    ...
                    <div class="form-group" >
                        ...
                        <div class="col-md-6" style="margin-top: 25px">
                              <input type="checkbox" name="room_type" id="room_type" value="on" checked data-toggle="toggle" data-on="Privé" data-off="Public" <?php echo e(old('room_type') == 'on' ? 'checked' : ''); ?> >
                        </div>
                    ...
                    <div id="divRoomCode" class="form-group " >
                          ...
                          <div class="col-md-12" style="margin-bottom: 15px">
                                <input id="room_code" type="text" class="my-input-texte form-control<?php echo e($errors->has('room_code') ? ' is-invalid' : ''); ?>" style="float: left; width: 90%" name="room_code" value="" placeholder="6 caractètes min.">
                            ...
                            <?php if($errors->has('room_code')): ?>                                    
                              <span class="invalid-feedback" role="alert">
                                    <br><br><br>
                                    <strong><?php echo e($errors->first('room_code')); ?></strong>
                              </span>                         
                            <?php endif; ?>
                        </div>                    
                    </div>     
