...
<head>
    ...
    <title><?php echo e(config('app.name', 'Dawi khawi')); ?></title>

    <!-- Scripts -->
    <script src="<?php echo e(asset('js/app.js')); ?>" defer></script>
    <script src="<?php echo e(asset('js/my-javascript.js')); ?>" defer></script>
...
<body>
      ...
      <nav class="navbar navbar-expand-md navbar-light navbar-laravel " style="border-bottom: 1px solid #C22030">
            <div class="container">
                  ...
                  <a class="navbar-brand" href="<?php echo e(url('/')); ?>" style="padding: 5px">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      <ul class="navbar-nav ml-auto pull-right">
                          ...
                          <?php if(auth()->guard()->guest()): ?>
                                <li><a class="nav-link" href="<?php echo e(route('login')); ?>"  ><i class="fas fa-key"></i> Connexion</a></li>
                                <li><a class="nav-link" href="<?php echo e(route('register')); ?>"><i class="fas fa-pencil-alt"></i> Inscription</a></li>
                          <?php else: ?>
